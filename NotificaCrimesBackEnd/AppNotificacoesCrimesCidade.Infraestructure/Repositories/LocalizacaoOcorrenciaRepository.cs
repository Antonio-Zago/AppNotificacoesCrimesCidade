...
{
    public class LocalizacaoOcorrenciaRepository : Repository<LocalizacaoOcorrencia>, ILocalizacaoOcorrenciaRepository
    {
        public LocalizacaoOcorrenciaRepository(AppDbContext context) : base(context)
        {
        }
    }
}
