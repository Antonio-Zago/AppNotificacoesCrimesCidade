...
class TextFormFieldDescricao extends StatefulWidget {
  const TextFormFieldDescricao({
    super.key,
  ...
  @override
  State<TextFormFieldDescricao> createState() => _TextFormFieldDescricaoState();
}

class _TextFormFieldDescricaoState extends State<TextFormFieldDescricao> {
  @override
