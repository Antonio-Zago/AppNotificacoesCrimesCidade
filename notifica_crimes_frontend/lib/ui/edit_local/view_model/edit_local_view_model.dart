...
class EditLocalViewModel extends ChangeNotifier{

  EditLocalViewModel({required this.localRepository});
  ...
  Future<bool> saveLocal(String idLocal) async {
    carregandoTela = true;
    notifyListeners();
    try {
      if (formKey.currentState!.validate()) {

        var retorno = await localRepository.putLocal(nomeController.text,latitude!, longitude!, idLocal);
